    ...
    <div className="homepage">
      ...
      <main>
        <section className='homepage__section'>
          ...
          <h2 className='h2-homepage'>Víte, jaký je váš typ pokožky? </h2>
<p className='p-homepage'>Pojďme to zjistit spolu! Fitzpatrickova stupnice je metoda, kterou dermatologové používají ke klasifikaci různé typy pokožky na základě její reakce na sluneční záření. Tato stupnice je založena na vaší přirozené barvě pleti, schopnosti opalování a citlivosti na slunce. Pro vás je důležité vědět, jaký máte typ pokožky, abyste mohli vybrat správnou péči a ochranu, která bude nejlépe vyhovovat vašim individuálním potřebám. Pojďte tedy zodpovědět několik otázek a zjistit!</p>
